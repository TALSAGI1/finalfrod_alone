...
item_ns.add_resource(Item, '/items/<int:id>')  # Example: /api/items/1
items_ns.add_resource(ItemList, "/items")      # Example: /api/items
store_ns.add_resource(Store, '/stores/<int:id>')  # Example: /api/stores/1
stores_ns.add_resource(StoreList, "/stores")      # Example: /api/stores

# Example simple route
@app.route('/')
def index():
    return "Welcome to the Sample Flask-RestPlus Application!"
